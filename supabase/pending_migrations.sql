-- Planner: migrations 0008 through 0014
-- Paste into the Supabase SQL editor and run, in this order.
-- All are safe to re-run.
--
-- 0013 creates a storage bucket and policies on storage.objects, so it
-- needs to be run by an owner role — the SQL editor qualifies.
